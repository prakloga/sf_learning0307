//https://github.com/Snowflake-Labs/sf-samples/blob/main/samples/tasty_bytes/tb_introduction.sql
...
CREATE OR REPLACE USER IDENTIFIER('"TASTY_ADMIN_USER"') 
COMMENT = "Holds tasty bytes admin access"
PASSWORD = 'tbAdmin@01'
LOGIN_NAME = 'TASTY_ADMIN_USER' 
DISPLAY_NAME = 'TASTY_ADMIN_USER'
FIRST_NAME = "PRAKASH"
LAST_NAME = "LOGANATHAN"
EMAIL = "<>"
MUST_CHANGE_PASSWORD = FALSE
DEFAULT_ROLE = 'TASTY_ADMIN' 
DEFAULT_WAREHOUSE = 'TASTY_DE_WH' 
DEFAULT_NAMESPACE = 'frostbyte_tasty_bytes.raw_pos'
DEFAULT_SECONDARY_ROLES = ( 'ALL' )
;

USE ROLE SECURITYADMIN;
GRANT ROLE tasty_admin TO USER tasty_admin_user;
